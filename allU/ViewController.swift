...
public class MapViewController: UIViewController {
    ...
    internal var showsBearingImage: Bool = true { //was set to value
        didSet {
            syncPuckAndButton()
        }
    }
    override public func viewDidLoad() {
        ...
        let cameraOptions = CameraOptions(center: CLLocationCoordinate2D(latitude: 33.871173, longitude: 118.403102), zoom: 4.5, bearing: -17.6, pitch: 45)
